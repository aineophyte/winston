 ...
 * guide by Radul.
 * 
 * Computes the sum of the input cells that are set.  The caller is free to set the content
 ...
 */
public class SumPropagator extends MultiNumberInputPropagator
{
	@SafeVarargs
	public SumPropagator(Cell<Number> output, Cell<Number> ...cells)
	{
		super(output, cells);
	}
